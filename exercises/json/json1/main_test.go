...
func TestJSONEncoding(t *testing.T) {
	person := Person{} // build the person struct to satisfy the expectJSON result
...
func TestDecodeJSONWithMissingField(t *testing.T) {
	jsonData := []byte(`{"name": "Alice", "age": 30}`) // this age field should be missing to pass the test
